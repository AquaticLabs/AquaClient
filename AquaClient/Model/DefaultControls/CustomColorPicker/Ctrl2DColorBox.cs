...
namespace adobe_color_picker_clone_part_1
{
	...
	public class Ctrl2DColorBox : System.Windows.Forms.UserControl
	{
		...
		private void DrawBorder()
		{
			...
			pencil = new Pen(Color.FromArgb(52,52,52));	//	The same gray color used by Photoshop
			g.DrawLine(pencil, this.Width - 2, 0, 0, 0);	//	Draw top line
			g.DrawLine(pencil, 0, 0, 0, this.Height - 2);	//	Draw left hand line

			pencil = new Pen(Color.FromArgb(105, 105, 105));	//	The same gray color used by Photoshop
			...
			pencil = new Pen(Color.FromArgb(28, 28, 28));
		...
		public void Reset_Marker(bool Redraw)
		{
			switch (m_eDrawStyle)
			{
				case eDrawStyle.Hue :
